      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            {/* Social Links */}
            <div className="pt-4">
              <h3 className="font-semibold text-text-primary mb-4">Connect with me</h3>
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-card border border-primary/20 flex items-center justify-center text-text-muted hover:text-primary hover:border-primary transition-all"
                  aria-label="GitHub"
                >
