...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await logActivity(supabase, {
      userId: admin.user.id, action: 'create', resourceType: 'blog', resourceId: data?.id ?? null,
    });
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await logActivity(supabase, {
      userId: admin.user.id, action: 'update', resourceType: 'blog', resourceId: data?.id ?? null,
    });
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    if (error) throw error;
    await logActivity(supabase, {
      userId: admin.user.id, action: 'delete', resourceType: 'blog', resourceId: id,
    });
